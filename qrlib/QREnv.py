...
class QREnv:
    ...
    NO_PLATFORM = True              # Disable platform integration to avoid connection errors
    
    # IDENTIFIER = BuiltIn().get_variable_value("${identifier}")            # For platform v1
    IDENTIFIER = os.environ.get("identifier") or "default-bot-id"        # For platform v2 with fallback
    ...
    ENVIRONMENT = ENV_LOCAL  # Change to LOCAL to use localhost
